...
export const NoiseTrail = ({
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        "group relative overflow-hidden rounded-2xl bg-neutral-100 p-2 backdrop-blur-sm dark:bg-[#1F1C1C]",
        "shadow-[0px_0.5px_1px_0px_var(--color-neutral-300)_inset,0px_1px_0px_0px_var(--color-neutral-50)]",
        "dark:shadow-[0px_1px_0px_0px_var(--color-neutral-950)_inset,0px_1px_0px_0px_var(--color-neutral-900)]",
        "border border-[#3CB270]/10",
        backdropBlur &&
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <img
          src="https://ui.aceternity.com/noise.webp"
          alt=""
